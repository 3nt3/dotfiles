...
require('packer').startup(function(use)
  ...
  -- FIXME only use this until the PR is merged (https://github.com/simrat39/rust-tools.nvim/pull/307)
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'svelte', 'html' },
...
local servers = { 'clangd', 'pyright', 'tsserver', 'gopls', 'svelte', 'tailwindcss', 'html' }
