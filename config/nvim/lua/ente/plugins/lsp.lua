        ...
        config = function()
                ...
                settings = {
                    Lua = {
                        ...
                        workspace = {
                            ...
                            library = {
                                vim.env.VIMRUNTIME,
                                -- Neovim runtime types (replaces neodev.nvim)
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    -- Highlight references under cursor (per-buffer augroup prevents
                    -- autocmd accumulation on re-attach)
            ...
            -- Clean up per-buffer highlight augroup on LSP detach
            ...
            vim.api.nvim_create_autocmd("BufWritePre", {
                ...
                pattern = { "*.lua", "*.rs", "*.js", ".ts", "*.ts", "*.svelte", "*.c", "*.cpp" },
